...
```console
pip install public-hello --extra-index-url https://unlimited-robotics.github.io/skills/
```
...
```console
pip install public-hello==0.1 --extra-index-url https://unlimited-robotics.github.io/skills/
```
...
When running `pip install <package_name> --extra-index-url https://unlimited-robotics.github.io/skills/`, the following happen :

1. `pip` will look at `https://pypi.org/`, the default, public index, trying to find a package with the specified name.
2. If it can't find, it will look at `https://unlimited-robotics.github.io/skills/`.
...
Then you can install it with `pip install my_cool_tensorflow --extra-index-url https://unlimited-robotics.github.io/skills/`.
...
RUN --mount=type=secret,id=gh_auth,dst=/root/.netrc pip install <package_name> --extra-index-url https://unlimited-robotics.github.io/skills/
```
...
You can see a demo of such warning at [https://unlimited-robotics.github.io/skills/transformers/](https://unlimited-robotics.github.io/skills/transformers/).
